...
function App() {
  ...
  return (
    <div
      className="App"
      style={{ backgroundImage: "linear-gradient(#DBEEFE, white, #DBEEFE)" }}
    >
      <Grid
        container
        direction="row"
          ...
          >
            <Grid item xs={3}>
              <Button
                variant="contained"
                color="primary"
                style={{ backgroundColor: "#F1F9FF", color: "black" }}
                size="small"
              >
                create customer
              </Button>
          ...
          >
            ...
            <Grid item>
              <p style={{ marginTop: "5px", fontSize: "18px" }}>
                Shipment going through Chicago :
              </p>
            </Grid>
